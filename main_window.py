...
class MainWindow(QMainWindow):
    ...
    def setup_sidebar(self, main_layout):
        ...
        self.nav_list.setStyleSheet("""
            ...
            QListWidget::item {
                padding: 12px 20px;  /* Увеличил с 8px до 12px по вертикали */
        ...
        for item in nav_items:
            ...
            list_item.setSizeHint(QSize(100, 50))  # Увеличил с 40px до 50px
    ...
    def toggle_theme(self):
        ...
        show_success_message(self, "Успех",
                             f"Тема изменена на {'тёмную' if self.current_theme == 'dark' else 'светлую'}")
